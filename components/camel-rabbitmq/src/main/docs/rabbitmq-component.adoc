...
|===
| Name | Description | Default | Type
| *camel.component.rabbitmq.addresses* | If this option is set, camel-rabbitmq will try to create connection based on the setting of option addresses. The addresses value is a string which looks like server1:12345, server2:12345. The option is a com.rabbitmq.client.Address[] type. |  | String
