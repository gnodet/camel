...
@UriParams
public class Comprehend2Configuration implements Cloneable, AwsCommonConfiguration {
    ...
    @Metadata(required = true)
    private Comprehend2Operations operation = Comprehend2Operations.detectDominantLanguage;
     ...
     */
    public void setComprehendClient(ComprehendClient comprehendClient) {
    ...
    public Comprehend2Operations getOperation() {
        return operation;
    }
     ...
     */
    public void setOperation(Comprehend2Operations operation) {
    ...
    /**
     * The region in which the Comprehend client needs to work. When using this parameter, the configuration will expect
    ...
    /**
     * The language code of the input text. Required for all operations except detectDominantLanguage. Use a 2-letter
     * ISO 639-1 code (e.g., 'en' for English, 'es' for Spanish).
     */
    ...
    /**
     * The Amazon Resource Name (ARN) of the endpoint to use for document classification. Required for classifyDocument
     * operation.
     */
    ...
    /**
     * Set whether the Comprehend client should expect to load credentials through a default credentials provider or to
    ...
    /**
     * Set whether the Comprehend client should expect to load credentials through a profile credentials provider.
     */
    ...
    /**
     * Set whether the Comprehend client should expect to use Session Credentials. This is useful in a situation in
     * which the user needs to assume an IAM role for doing operations in Comprehend.
     */
    ...
    public Comprehend2Configuration copy() {
        try {
            return (Comprehend2Configuration) super.clone();
