...
@UriParams
public class Rekognition2Configuration implements Cloneable, AwsCommonConfiguration {
    ...
    @UriParam
    @Metadata(required = true)
    private Rekognition2Operations operation;
     ...
     */
    public void setAwsRekognitionClient(RekognitionClient awsRekognitionClient) {
        this.awsRekognitionClient = awsRekognitionClient;
    }
    ...
    /**
     * The region in which Rekognition client needs to work. When using this parameter, the configuration will expect
    ...
    public Rekognition2Operations getOperation() {
        return operation;
    }
     ...
     */
    public void setOperation(Rekognition2Operations operation) {
    ...
    /**
     * Set whether the Rekognition client should expect to load credentials through a default credentials provider or to
    ...
    /**
     * Set whether the Rekognition client should expect to load credentials through a profile credentials provider.
     */
    ...
    /**
     * Set whether the Rekognition client should expect to use Session Credentials. This is useful in a situation in
     * which the user needs to assume an IAM role for doing operations in Rekognition.
     */
    ...
    public Rekognition2Configuration copy() {
        try {
            return (Rekognition2Configuration) super.clone();
