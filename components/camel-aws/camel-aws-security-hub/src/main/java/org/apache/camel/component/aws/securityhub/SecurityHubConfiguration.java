...
@UriParams
public class SecurityHubConfiguration implements Cloneable, AwsCommonConfiguration {
    ...
    private SecurityHubOperations operation = SecurityHubOperations.batchImportFindings;
    ...
    public SecurityHubClient getSecurityHubClient() {
     ...
     */
    public void setSecurityHubClient(SecurityHubClient securityHubClient) {
    ...
    public SecurityHubOperations getOperation() {
        return operation;
    }
     ...
     */
    public void setOperation(SecurityHubOperations operation) {
    ...
    /**
     * The region in which the Security Hub client needs to work. When using this parameter, the configuration will
    ...
    /**
     * Set whether the Security Hub client should expect to load credentials through a default credentials provider or
    ...
    /**
     * Set whether the Security Hub client should expect to use Session Credentials. This is useful in a situation in
     * which the user needs to assume an IAM role for doing operations in Security Hub.
     */
    ...
    public SecurityHubConfiguration copy() {
        try {
