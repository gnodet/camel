...
| *nodes* (common) | The nodes the AtomixClient should connect to |  | String
...
| *camel.component.atomix-messaging.nodes* | The nodes the AtomixClient should connect to |  | String
