...
| *nodes* (consumer) | The nodes the AtomixClient should connect to |  | String
...
| *camel.component.atomix-multimap.nodes* | The nodes the AtomixClient should connect to |  | String
