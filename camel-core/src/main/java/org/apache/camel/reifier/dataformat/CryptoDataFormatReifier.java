...
public class CryptoDataFormatReifier extends DataFormatReifier<CryptoDataFormat> {
    ...
    public CryptoDataFormatReifier(DataFormatDefinition definition) {
        super(CryptoDataFormat.class.cast(definition));
    }
    ...
    protected DataFormat createDataFormat(RouteContext routeContext) {
        ...
        if (ObjectHelper.isNotEmpty(definition.getKeyRef())) {
            Key key = CamelContextHelper.mandatoryLookup(routeContext.getCamelContext(), definition.getKeyRef(), Key.class);
        ...
        if (ObjectHelper.isNotEmpty(definition.getInitVectorRef())) {
            byte[] iv = CamelContextHelper.mandatoryLookup(routeContext.getCamelContext(), definition.getInitVectorRef(), byte[].class);
