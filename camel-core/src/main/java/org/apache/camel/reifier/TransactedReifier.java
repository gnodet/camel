...
class TransactedReifier extends ProcessorReifier<TransactedDefinition> {
    ...
    protected Policy resolvePolicy(RouteContext routeContext) {
        ...
        return doResolvePolicy(routeContext, definition.getRef(), definition.getType());
    }

    public static Policy doResolvePolicy(RouteContext routeContext, String ref, Class<? extends Policy> type) {
