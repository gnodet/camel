...
public abstract class FhirDataformatReifier<T extends FhirDataformat> extends DataFormatReifier<T> {

    public FhirDataformatReifier(T definition) {
        super(definition);
    }
    ...
    protected void configureDataFormat(DataFormat dataFormat, CamelContext camelContext) {
        ...
        if (ObjectHelper.isNotEmpty(definition.getEncodeElementsAppliesToResourceTypes())) {
            setProperty(camelContext, dataFormat, "encodeElementsAppliesToResourceTypes", definition.getEncodeElementsAppliesToResourceTypes());
        }
