 ...
 */
public class StringDataFormatReifier extends DataFormatReifier<StringDataFormat> {

    public StringDataFormatReifier(DataFormatDefinition definition) {
        super(StringDataFormat.class.cast(definition));
    }
