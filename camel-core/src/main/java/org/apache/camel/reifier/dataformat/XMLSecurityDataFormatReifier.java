...
public class XMLSecurityDataFormatReifier extends DataFormatReifier<XMLSecurityDataFormat> {
    ...
    public XMLSecurityDataFormatReifier(DataFormatDefinition definition) {
        super(XMLSecurityDataFormat.class.cast(definition));
    }
    ...
    protected void configureDataFormat(DataFormat dataFormat, CamelContext camelContext) {
        ...
        if (definition.getKeyOrTrustStoreParametersId() != null) {
            setProperty(camelContext, dataFormat, "keyOrTrustStoreParametersId", definition.getKeyOrTrustStoreParametersId());
        }
