 ...
 */
package org.apache.camel.tooling.apigen.model;
...
public class ApiProxy {
    ...
    private String fromSignatureFile;
    ...
    public String getFromSignatureFile() {
        return fromSignatureFile;
    }

    public void setFromSignatureFile(String fromSignatureFile) {
    ...
    public void validate() {
        if (apiName == null || proxyClass == null) {
            throw new RuntimeException("Properties apiName and proxyClass are required");
        }
    }
}
