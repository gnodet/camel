 ...
 */
@Mojo(name = "generate-dataformats-list", threadSafe = true, defaultPhase = LifecyclePhase.PROCESS_CLASSES, requiresDependencyResolution = ResolutionScope.RUNTIME)
public class PackageDataFormatMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        Project.project(getLog(), project, buildContext).prepareDataFormat(dataFormatOutDir.toPath(), schemaOutDir.toPath());
    }
