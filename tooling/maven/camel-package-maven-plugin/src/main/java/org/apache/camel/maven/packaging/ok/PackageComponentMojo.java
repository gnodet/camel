 ...
 */
@Mojo(name = "generate-components-list", threadSafe = true, defaultPhase = LifecyclePhase.PROCESS_CLASSES, requiresDependencyResolution = ResolutionScope.RUNTIME)
public class PackageComponentMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        Project.project(getLog(), project, buildContext).prepareComponent(componentOutDir.toPath());
    }
