 ...
 */
@Mojo(name = "generate-static-core-converter", threadSafe = true, defaultPhase = LifecyclePhase.PROCESS_CLASSES, requiresDependencyResolution = ResolutionScope.RUNTIME)
public class PackageConverterMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        Project.project(getLog(), project, buildContext).createConverter(converterOutDir.toPath());
