 ...
 */
@Mojo(name = "generate-model-doc", threadSafe = true, defaultPhase = LifecyclePhase.PROCESS_CLASSES, requiresDependencyResolution = ResolutionScope.RUNTIME)
public class PackageModelDocMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        Project.project(getLog(), project, buildContext).processModelDoc(modeldocOutDir.toPath());
