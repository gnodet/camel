 ...
 */
package org.apache.camel.tooling.packaging.model;
...
import static org.apache.camel.tooling.packaging.helpers.StringHelper.cutLastZeroDigit;
...
public class DataFormatModel {
    ...
    public void addDataFormatOption(DataFormatOptionModel option) {
        if (dataFormatOptions.stream().noneMatch(o -> Objects.equals(o.getName(), option.getName()))) {
