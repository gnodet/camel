 ...
 */
@Mojo(name = "generate-services-list", threadSafe = true, defaultPhase = LifecyclePhase.PROCESS_CLASSES, requiresDependencyResolution = ResolutionScope.RUNTIME)
public class PackageServicesMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        Project.project(getLog(), project, buildContext).prepareServices(serviceOutDir.toPath());
    }
