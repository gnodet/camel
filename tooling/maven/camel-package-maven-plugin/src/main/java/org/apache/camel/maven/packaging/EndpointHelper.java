...
public final class EndpointHelper {
    ...
    private static final class EndpointPathComparator implements Comparator<EndpointPathModel> {
        ...
        @Override
        public int compare(EndpointPathModel path1, EndpointPathModel path2) {
