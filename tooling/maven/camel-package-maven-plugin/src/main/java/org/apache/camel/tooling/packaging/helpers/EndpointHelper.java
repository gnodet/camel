...
public final class EndpointHelper {
     ...
     * </ul>
     */
    private static final class EndpointOptionGroupAndLabelComparator implements Comparator<EndpointOptionModel> {

        @Override
        public int compare(EndpointOptionModel o1, EndpointOptionModel o2) {
    ...
    private static final class EndpointPathComparator implements Comparator<EndpointOptionModel> {
        ...
        @Override
        public int compare(EndpointOptionModel path1, EndpointOptionModel path2) {
