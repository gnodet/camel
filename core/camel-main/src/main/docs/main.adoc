...
| *camel.main.devConsoleEnabled* | Whether to register MCP tools based on the DevConsole registry. By default, this is enabled. | true | boolean
...
| *camel.main.transport* | Transport to use for the MCP server (stdio, uds, tcp). | stdio | String
